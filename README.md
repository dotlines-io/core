...
[![GitHub Tests Action Status](https://img.shields.io/github/workflow/status/dotlines-io/core/run-tests.yml?label=tests)](https://github.com/dotlines-io/core/actions?query=workflow%3ATests+branch%3Amaster)
